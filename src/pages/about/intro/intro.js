          ...
          <MDBCol sm={12}>
            <div className='h-100vh w-100'>
              ...
              <p className='text-center mx-auto mb-5 w-responsive'>
                This is me (song&lsquos in your head now). I built this little
                old site to showcase my skills and generally show off some of my
                personality, that as you have no doubt already surmised is on
                the dry wit side...
                <br />
          ...
          <MDBCol lg={7}>
            <MDBCol size={12} md={12} xl={10} className='px-3'>
              <p>
                ...
                (its a word) Space Marine. I believe it is what`&lsquo;`s
                referred to as declaring if you have any addictions... Yes I do.
                Its called Warhammer 40K.
              </p>
              <p>
                Seriously its my main hobby apart from Gaming{' '}
                <MDBIcon fab icon='playstation' /> and{' '}
                <MDBIcon icon='desktop' />, look at them pretty icons. So gaming
                is a big part of who I am. I have been gaming since the days of
                the Atari 2600 (centipede was my go to game). Now its mostly
                PlayStation 4 or my PC. Gamertags can be found further down the
                page if you`&lsquo;`re interested in checking me out. Awesome
              ...
              <p>
                I was going to mention my family of 3 boys and the wife but not
                fair to place them on here so we`&lsquo;`ll skip them for now.
              </p>
              <p></p>
            </MDBCol>
          </MDBCol>
